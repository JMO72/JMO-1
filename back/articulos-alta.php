...
<?php
    ...
    if($_FILES['foto']['name'] != ""){ // El campo foto contiene una imagen...
     ...
     // $allowedExts = array("jpg", "jpeg", "gif", "png", "JPG", "GIF", "PNG");
		...
		$sql="Insert into articulos (marca,  modelo,  publicar, foto)
				values ('$marca',  '$modelo','1', '$foto')";
...
<div class="controls">
                            <input name="modelo" type="text" class="input-xlarge focused" id="focusedInput"  required="required">
